...
The console host stays in `Words.Xbox`. The Xbox package target lives in `src/Words.Xbox.Package/Words.Xbox.Package.wapproj`.
...
`dotnet msbuild src/Words.Xbox.Package/Words.Xbox.Package.wapproj /p:Configuration=Debug /p:Platform=x64`
